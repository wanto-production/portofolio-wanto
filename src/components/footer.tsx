  ...
  return (
    <footer className="bg-gradient-to-b from-[#1a1a1a] to-[#0c0c0c] border-t border-gray-800">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-xl font-bold text-white">Ikhwan Satrio</h3>
                <p className="text-gray-400 text-sm">Young Programmer</p>
              </div>
            </div>
        ...
        {/*           className="flex-1 px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all" */}
        {/*         /> */}

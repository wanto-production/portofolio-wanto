...
export default function ContactPage() {
  ...
  return (
    <main className="w-full min-h-screen">
      ...
      <section className="relative w-full min-h-screen flex flex-col items-center justify-center gap-4 sm:gap-6 md:gap-8 bg-[radial-gradient(circle_at_center,_#1a1a1a,_#0c0c0c)] overflow-hidden px-4 sm:px-6 md:px-8">
        {/* Background Rays */}
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto text-center space-y-6 sm:space-y-8">
          <div className="flex flex-col items-center justify-center text-center space-y-4 sm:space-y-6">
            ...
            <p className="font-inter text-base sm:text-lg md:text-xl lg:text-2xl text-gray-400 max-w-xs sm:max-w-lg md:max-w-2xl lg:max-w-3xl mx-auto leading-relaxed px-2">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center w-full max-w-lg sm:max-w-none mx-auto">
            <a
              href="mailto:ikwansatria3974@gmail.com"
              className="w-full sm:w-auto px-6 sm:px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-medium shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 text-center"
            >
              Send me an Email
            </a>
            <div className="text-gray-400 text-xs sm:text-sm text-center">or fill out the form below</div>
          </div>
        </div>
        ...
        <div className="absolute bottom-6 sm:bottom-8 left-1/2 transform -translate-x-1/2 z-10 hidden sm:block">
          <div className="flex flex-col items-center animate-bounce">
            <span className="text-gray-400 text-xs sm:text-sm mb-2">Get in Touch</span>
      ...
      <section className="w-full bg-gradient-to-b from-[#0c0c0c] to-[#1a1a1a] py-12 sm:py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12">
            {/* Contact Form */}
            <div className="space-y-6 sm:space-y-8 order-2 lg:order-1">
              <div>
                <h2 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent mb-3 sm:mb-4">
                  Send me a Message
                </h2>
            ...
            <div className="space-y-6 sm:space-y-8 order-1 lg:order-2">
              ...
              <div className="space-y-3 sm:space-y-4">
                {contactMethods.map((method) => (
                  <a
                    ...
                    className="group block p-4 sm:p-6 bg-gray-900/50 rounded-xl sm:rounded-2xl border border-gray-700/50 backdrop-blur-sm hover:border-gray-600/50 transition-all duration-300"
                  >
                    <div className="flex items-start gap-3 sm:gap-4">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-lg flex items-center justify-center text-blue-400 group-hover:from-blue-600/30 group-hover:to-purple-600/30 transition-all duration-300 flex-shrink-0">
                        {method.icon}
                      </div>
                      <div className="flex-1 min-w-0">
                        <h3 className="font-semibold text-white group-hover:text-blue-400 transition-colors duration-300 text-sm sm:text-base">
                          {method.title}
                        </h3>
                        <p className="text-gray-400 group-hover:text-gray-300 transition-colors duration-300 mb-1 text-sm sm:text-base break-words">
                          {method.value}
                        </p>
              ...
              <div className="p-4 sm:p-6 bg-gradient-to-br from-green-600/10 to-emerald-600/10 rounded-xl sm:rounded-2xl border border-green-600/30">
                <div className="flex items-center gap-3 mb-2 sm:mb-3">
                  ...
                  <h3 className="font-semibold text-white text-sm sm:text-base">Currently Available</h3>
                </div>
      ...
      <section className="w-full bg-gradient-to-b from-[#1a1a1a] to-[#0c0c0c] py-12 sm:py-16 md:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent mb-4 sm:mb-6">
          ...
          <div className="space-y-4 sm:space-y-6">
            {faqs.map((faq, index) => (
              <div
                key={index}
                className="bg-gray-900/50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-700/50 backdrop-blur-sm"
              >
                <h3 className="text-base sm:text-lg font-semibold text-white mb-2 sm:mb-3 leading-snug">
                  {faq.question}
                </h3>
      ...
      <section className="w-full bg-gradient-to-b from-[#0c0c0c] to-[#1a1a1a] py-12 sm:py-16 md:py-20">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-blue-600/10 via-purple-600/10 to-cyan-600/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 backdrop-blur-sm border border-gray-700/50">
            <h2 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent mb-4 sm:mb-6">
              Ready to Start Your Project?
            </h2>
            <p className="text-gray-300 text-base sm:text-lg mb-6 sm:mb-8 max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center max-w-md sm:max-w-none mx-auto">
              <a
                href="mailto:ikwansatria3974@gmail.com"
                className="px-6 sm:px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-medium shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 text-sm sm:text-base"
              >
                Start the Conversation
              </a>
              <Link
                href="/projects"
                className="px-6 sm:px-8 py-3 border border-gray-600 text-gray-300 rounded-xl font-medium hover:bg-gray-800 hover:text-white transition-all duration-300 text-sm sm:text-base"
              >
                View My Work
              </Link>
            </div>
...
export const metadata: Metadata = {
  title: "Contact",
  description: "Get in touch with Ikhwan Satrio - Frontend Developer. Contact me for web development projects, collaborations, or just to say hello. Available for freelance work and exciting opportunities.",
}

  ...
  return (
    <main className="w-full min-h-screen">
      <section className="relative w-full h-screen text-center flex flex-col items-center justify-center gap-8 bg-[radial-gradient(circle_at_center,_#1a1a1a,_#0c0c0c)] overflow-hidden">
        ...
        {/* Call to Action */}
        <div className="mt-8 flex flex-wrap gap-4 justify-center z-2">
          <a
            href="#projects"
            className="min-w-[150px] text-center px-6 py-2 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 text-white font-medium shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300"
          >
            View Projects
          </a>
          <a
            ...
            target="_blank"
            className="min-w-[150px] text-center px-6 py-2 rounded-xl border border-gray-600 text-gray-300 font-medium hover:bg-gray-800 hover:text-white flex items-center justify-center gap-2 transition-all duration-300"
          >
...
export const metadata: Metadata = {
  title: "ikhwan | Home",
  description: "Personal portfolio of Ikhwan Satrio - Frontend Developer",
}
